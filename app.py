...
from get_data import filter_by_country, get_coutries
...
def explain(country):
    ...
    * Current Recoveries: {}
    * Date Rate : {}%
    * Recovery Rate : {}%""".format(country, confirmed_current, deaths_current, recovered_current, death_rate, recovery_rate)
